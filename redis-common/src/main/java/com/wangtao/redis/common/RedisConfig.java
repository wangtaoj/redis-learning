package com.wangtao.redis.common;
...
public class RedisConfig {
    ...
    public <V> RedisTemplate<String, V> redisTemplate(RedisConnectionFactory connectionFactory) {
        ...
        RedisSerializer<Object> valueRedisSerializer = initValueRedisSerializer();
    ...
    private RedisSerializer<Object> initValueRedisSerializer() {
